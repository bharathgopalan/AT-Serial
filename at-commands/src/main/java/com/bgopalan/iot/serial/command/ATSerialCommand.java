 ...
 * \*-------------------------------------------------------------------------------------------------------------------*/
package com.bgopalan.iot.serial.command;
...
public enum ATSerialCommand implements SerialCommand {
	...
	/*Wait for an image Query for 300 seconds*/
	ZB_IMGQUERY("IMGQUERY", CommandType.LISTEN, 300, "IMGQUERY:"),
	;
	
	// The command seperator(that seperates the command and the command params) , Please pay extra care for this
