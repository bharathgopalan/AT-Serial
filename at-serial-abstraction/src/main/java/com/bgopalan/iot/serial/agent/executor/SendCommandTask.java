 ...
 * \*-------------------------------------------------------------------------------------------------------------------*/
package com.bgopalan.iot.serial.agent.executor;
...
import com.bgopalan.iot.serial.agent.abstraction.SerialInterface;
import com.bgopalan.iot.serial.agent.command.CommandRequest;
import com.bgopalan.iot.serial.agent.command.CommandResult;
import com.bgopalan.iot.serial.agent.command.CommandStatus;
import com.bgopalan.iot.serial.agent.util.StringUtil;
import com.bgopalan.iot.serial.command.SerialCommand;
import com.bgopalan.iot.serial.command.SerialCommand.CommandType;
