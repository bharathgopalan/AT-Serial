 ...
 * \*-------------------------------------------------------------------------------------------------------------------*/
package com.bgopalan.iot.serial.agent.util;
...
public class StringUtil {
	...
	public static void main(String args[]){
		System.out.println(StringUtil.getMatchingString(Arrays.asList(new String[]{"IMGQUERY:D6D6,09,00,1039,0203,01045700,02"}), "IMGQUERY:D6D6").size());
	}
